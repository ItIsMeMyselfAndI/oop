...
class Tabs(ctk.CTkFrame):
    def __init__(self, pages, master, **kwargs):
        ...
        # open default tab
        self.pages["expense"].grid(row=2, column=0, sticky="nsew")
        self.expenseBtn.configure(fg_color="#559eef", hover_color="#427cbd", text_color="white")

    def on_click_expense(self):
        # close other pages
        self.pages["savings"].grid_forget()
        self.pages["investment"].grid_forget()
        self.pages["income"].grid_forget()
    ...
    def on_click_savings(self):
        # close other pages
        self.pages["expense"].grid_forget()
        self.pages["investment"].grid_forget()
        self.pages["income"].grid_forget()
        # reset fg, hover & text color of other buttons
        ...
        self.pages["savings"].grid(row=2, column=0, sticky="nsew")
    ...
    def on_click_investment(self):
        ...
        self.pages["investment"].grid(row=2, column=0, sticky="nsew")
    ...
    def on_click_income(self):
        ...
        self.pages["income"].grid(row=2, column=0, sticky="nsew")
