...
class EditStyles:
    ...
    TRANSACTION_LABEL_TEXT_COLOR = BaseStyles.DARK_GREY
    TRANSACTION_MENU_FG_COLOR = BaseStyles.BLUE
    TRANSACTION_MENU_TEXT_COLOR = BaseStyles.DARK_GREY
    TRANSACTION_DROPDOWN_FG_COLOR = BaseStyles.WHITE
    TRANSACTION_DROPDOWN_HOVER_COLOR = BaseStyles.BLUE
