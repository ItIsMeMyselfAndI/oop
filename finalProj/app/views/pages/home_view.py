...
# our modules/libs
from views.styles import BaseStyles, HomeStyles # paddings, dimensions, colors, etc
from views.widgets.table import TransactionTableHeader, TransactionTableBody 
...
class HomePageView(ctk.CTkFrame):
    ...
    def _load_icon(self):
        ...
        if hasattr(sys, "_MEIPASS"): # # for .exe: memory resources path
            ...
            ICONS_FOLDER = os.path.join(_MEIPASS, "views/assets/icons")
        else: # for .py: storage resources path
            ICONS_FOLDER = "views/assets/icons"
        print(ICONS_FOLDER)
