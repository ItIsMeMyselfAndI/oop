...
class PopUpWin(ctk.CTkToplevel):
    def __init__(self, title: str, msg: str, enable_close: bool, enable_frame_blocker: bool, font: tuple, master, **kwargs):
        ...
        # create content
        self.label = ctk.CTkLabel(master=self, font=font, text=msg, text_color=BaseStyles.DARK_GREY,
