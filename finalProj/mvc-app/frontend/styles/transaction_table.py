...
class TransactionTableStyles:
    ...
    NAV_PREV_ON_BTN_FG_COLOR = BaseStyles.BLUE
    NAV_PREV_BTN_HOVER_COLOR = BaseStyles.DARK_BLUE
    NAV_PREV_ON_BTN_TEXT_COLOR = BaseStyles.WHITE
    NAV_PREV_OFF_BTN_FG_COLOR = BaseStyles.DARK_BLUE
    ...
    PAGE_NUM_LABEL_TEXT_COLOR = BaseStyles.DARK_GREY

    NAV_NEXT_ON_BTN_FG_COLOR = BaseStyles.BLUE
    NAV_NEXT_BTN_HOVER_COLOR = BaseStyles.DARK_BLUE
    NAV_NEXT_ON_BTN_TEXT_COLOR = BaseStyles.WHITE
    NAV_NEXT_OFF_BTN_FG_COLOR = BaseStyles.DARK_BLUE
